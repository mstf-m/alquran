  ...
  return (
    ...
    >
      <div className="flex items-center">
        <span className="rounded-full border-8 border-[#CCF3FA] w-14 h-14 flex justify-center items-center -translate-x-4 bg-white group-hover:bg-blue-primary text-neutral-color-800 group-hover:text-white">
          {data.number}
        </span>
        <div>
