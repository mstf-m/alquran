  ...
  return (
    <main>
      <FullpageProvider>
              ...
              <div className=" flex flex-col max-w-80 ml-20 mt-20 gap-10">
                <div className="rounded-2xl border-8 border-white/50 p-6 text-blue-text bg-white max-h-fit">
                  ...
                  <p className="text-xs">
                    ...
                    Introduction Alquran Introduction Alquran Alquran
                    Introduction Alquran Introduction Alquran Alquran
                    Introduction Alquran Introduction Alquran
                  </p>
                </div>
              ...
              <div className=" flex flex-col max-w-80 gap-10">
                <div className="rounded-2xl border-8 border-white/50 p-6 text-blue-text bg-white max-h-fit">
                  ...
                  <p className="text-xs">
                    ...
                    Introduction Alquran Introduction Alquran Alquran
                    Introduction Alquran Introduction Alquran Alquran
                    Introduction Alquran Introduction Alquran Introduction
                    Alquran Alquran Introduction Introduction Alquran
                    Introduction Alquran Alquran Introduction Introduction
                    Alquran Introduction Alquran Alquran
                    IntroductionIntroduction Alquran Introduction Alquran
                    Alquran Introduction Introduction Alquran Introduction
                    Alquran Alquran Introduction Introduction Alquran Alquran
                    Introduction Alquran Introduction Alquran Alquran
                    Introduction Alquran Introduction Alquran
                  </p>
                </div>
        ...
        <section className="pt-11 h-screen flex flex-col items-end relative">
          {/* need change */}
          <div className="flex flex-col items-end bg-cream-gradient container float-right rounded-s-3xl">
            <div className="flex gap-2 section-title rounded-s-full py-5 pl-4 pr-40">
              <SvgQuran />
